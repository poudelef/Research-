...
This class is further categorized into three types based on the context of the summarization:


* Multi-modal: This method creates summaries by using a combination of different data types, or "modalities," such as audio, text, and visual information. For instance, a textual-visual approach might use text or language analysis alongside visual content for summarization. One method projects textual and visual data into a common latent space to maximize the summary's relevance to video metadata. Another approach combines latent common and modality-specific information for summarization.
